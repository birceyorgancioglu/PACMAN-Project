    ...
    switch (this.dir) {
      case UP:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 11) / 18,
          2 * Math.PI - (Math.PI * 7) / 18,
          true
        );
        break;
      case DOWN:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 29) / 18,
          2 * Math.PI - (Math.PI * 25) / 18,
          true
        );
        break;
      case LEFT:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 10) / 9,
          2 * Math.PI - (Math.PI * 8) / 9,
          true
        );
        break;
      case RIGHT:
    ...
    switch (this.dir) {
      case UP:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 7) / 9,
          2 * Math.PI - (Math.PI * 2) / 9,
          true
        );
        break;
      case DOWN:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 16) / 9,
          2 * Math.PI - (Math.PI * 11) / 9,
          true
        );
        break;
      case LEFT:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 23) / 18,
          2 * Math.PI - (Math.PI * 13) / 18,
          true
        );
        break;
      case RIGHT:
        ctx.arc(
          ...
          this.y,
          this.radius,
          2 * Math.PI - (Math.PI * 5) / 18,
          2 * Math.PI - (Math.PI * 31) / 18,
          true
        );
        break;
      default:
